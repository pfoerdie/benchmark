...
export default class AsyncTest<T> {

  #label: string
  #tester: (value: T) => Promise<any>
  #runs: number
  #timer: Timer

  constructor(label: string, tester: (value: T) => Promise<any>) {
  ...
  async exec(dataArr: Array<T>): Promise<this> {
